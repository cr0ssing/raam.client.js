...
class RAAMReader {
     ...
     * @throws {Error} if the serverURL is not passed and hasn't been set already.
     */
    static subscribeIndex(channelRoot, index, callback, {serverURL, subscribeFollowing = false, channelPassword, messagePassword, height, security} = {}) {
        if (serverURL) {
        ...
        let result = {index, callback, channelRoot, subscribeFollowing}
